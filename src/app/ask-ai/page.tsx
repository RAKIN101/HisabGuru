...
export default function AskAI() {
  ...
  const send = async () => {
    ...
    try {
      ...
      if (parsed && (parsed.action === "add_transaction" || parsed.action === "add_to_last" || parsed.action === "add_to_specific" || parsed.action === "set_savings_goal" || parsed.action === "financial_advice")) {
    ...
    <div className="flex flex-col py-5" style={{ height: "calc(100vh - 140px)" }}>
          ...
          <div className="flex h-full items-center justify-center">
            <div className="text-center">
              ...
              <div className="mt-3 space-y-1 text-xs text-gray-500">
                ...
                <p>• "I want to save 1000tk this month"</p>
                <p>• "Give me advice on budgeting"</p>
              </div>
            </div>
          </div>
        )}
      ...
      <div className="flex gap-2">
        <input
          ...
          placeholder="Try: 'I want to save 1000tk this month' or 'Give me budgeting advice'..."
        />
        <motion.button 
          onClick={send} 
